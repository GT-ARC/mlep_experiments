...
'''
class NeuralNetworkAlgorithmSelectorAUC(AlgorithmSelector):
    ...
    def process(self, budget, callback):
        ...
        while ( ( remainingBudget > 0 ) & ( len(algorithms)>0 ) ):
            ...
            #if we want to optimize the AUC instead of the final algorithm selection, we need to consider how much time remains after getting the benefit:
            estimatedPerformances = estimatedScores * (remainingBudget - estimatedCosts)
